 ...
 * Purpose: Light gun / light pen input device support for MAME
 *
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║                    🔫 LIGHT GUN HANDLER 🎯                            ║
 * ║  ┌──────────────────────────────────────────────────────────────┐    ║
 ...
 * ║  │      ║   [HIT!] ■     ║        / \                          │    ║
 * ║  │      ╚════════════════╝                                      │    ║
 * ║  │   VBlank interrupt reads VPOSR for precise aim!             │    ║
 * ║  └──────────────────────────────────────────────────────────────┘    ║
 * ║         Captures beam position when light pen triggers!               ║
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * Author: krb
 * Copyright (C) 2025
...
/*
 * Pew pew! Bulls-eye every time! 🎯
 *      ^..^
 *     (o_o)  <- This hawk has excellent aim too!
 *     |> <|
 */
