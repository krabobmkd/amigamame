...
option(OPT_MIDWAYMCR "" OFF)
option(OPT_MIDWAYTUNIT "" OFF)
option(OPT_MINIATARI "" OFF)
option(OPT_MINIDTEA "" OFF)
option(OPT_MINIKONAMI "" OFF)
option(OPT_MINIKONAMI2 "" OFF)
option(OPT_MINIKONAMI3 "" OFF)
option(OPT_MININAMCOS1 "" OFF)
option(OPT_MISC "" OFF)
...
if(OPT_ALPHA)
	...
	set(MSND_YM2413 ON)
	set(MSND_YM3812 ON)
	set(MCPU_ALPHA8201 ON)
	set(MCPU_ALPHA8301 ON)
	set(MCPU_M68000 ON)
	set(MCPU_Z80 ON)
	list(APPEND CPU_DEFS
	...
	list(APPEND CPU_DEFS
		HAS_ALPHA8201=1 HAS_ALPHA8301=1 HAS_M68000=1 HAS_Z80=1
	)
endif()
if(OPT_AMIGA)
...
if(OPT_ATARI)
	...
	set(MCPU_I386 ON)
	set(MCPU_JAGUAR ON)
	set(MCPU_JAGUARDSP ON)
	set(MCPU_JAGUARGPU ON)
	set(MCPU_M6502 ON)
	set(MCPU_M6800 ON)
	set(MCPU_M68000 ON)
	set(MCPU_M68010 ON)
	...
	list(APPEND CPU_DEFS
		HAS_ADSP2100=1 HAS_ADSP2101=1 HAS_ASAP=1 HAS_DSP32C=1
		HAS_I386=1 HAS_JAGUAR=1 HAS_JAGUARDSP=1 HAS_JAGUARGPU=1
		HAS_M6502=1 HAS_M6800=1 HAS_M68000=1 HAS_M68010=1
		HAS_M6809=1 HAS_M68EC020=1 HAS_MEDIAGX=1 HAS_R3000BE=1
		HAS_S2650=1 HAS_T11=1 HAS_TMS32010=1 HAS_TMS32031=1
		HAS_TMS34010=1 	)
endif()
if(OPT_ATLUS)
...
if(OPT_CINEMAT)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YM2151=1 	)
	list(APPEND CPU_DEFS
		HAS_CCPU=1 HAS_I186=1 HAS_I86=1 HAS_M68000=1
		HAS_S2650=1 HAS_Z80=1 	)
endif()
if(OPT_COMAD)
	...
	list(APPEND CPU_DEFS
		HAS_M68000=1 HAS_M6805=1 HAS_M68705=1 HAS_Z80=1
	)
endif()
if(OPT_CVS)
	...
	list(APPEND CPU_DEFS
		HAS_I8035=1 HAS_I8039=1 HAS_S2650=1 	)
endif()
if(OPT_DATAEAST)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YM2203=1 HAS_YM3526=1 HAS_YM3812=1 HAS_YMZ280B=1
	)
	list(APPEND CPU_DEFS
		HAS_ARM=1 HAS_DECO16=1 HAS_H6280=1 HAS_HD6309=1
		HAS_I8X41=1 HAS_M6502=1 HAS_M65C02=1 HAS_M68000=1
		HAS_M6809=1 HAS_SH2=1 HAS_Z80=1 	)
endif()
if(OPT_DOOYONG)
...
if(OPT_EDEVICES)
	...
	list(APPEND CPU_DEFS
		HAS_I86=1 HAS_I88=1 HAS_M68000=1 HAS_V20=1
		HAS_V30=1 HAS_Z80=1 	)
endif()
if(OPT_EOLITH)
...
if(OPT_F32)
	...
	list(APPEND CPU_DEFS
		HAS_E132XT=1 HAS_M68000=1 HAS_Z80=1 	)
endif()
if(OPT_FUUKI)
...
if(OPT_GAELCO)
	...
	set(MCPU_Z80 ON)
	list(APPEND CPU_DEFS
		HAS_DMADAC=1 HAS_GAELCO_CG1V=1 HAS_GAELCO_GAE1=1 HAS_MSM5205=1
		HAS_OKIM6295=1 HAS_SAA1099=1 HAS_YM2203=1 HAS_YM3812=1
	)
	list(APPEND CPU_DEFS
		HAS_ADSP2100=1 HAS_ADSP2115=1 HAS_M68000=1 HAS_M6809=1
		HAS_TMS32031=1 HAS_Z180=1 HAS_Z80=1 	)
endif()
if(OPT_GAMEPLAN)
	...
	list(APPEND CPU_DEFS
		HAS_AY8910=1 	)
	list(APPEND CPU_DEFS
		HAS_8080=1 HAS_M6502=1 HAS_M6800=1 HAS_Z80=1
	)
endif()
if(OPT_GAMETRON)
...
if(OPT_GOTTLIEB)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YM2151=1 	)
	list(APPEND CPU_DEFS
		HAS_I86=1 HAS_M6502=1 HAS_TMS34010=1 	)
endif()
if(OPT_GREYHND)
...
if(OPT_IGS)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YM3812=1 	)
	list(APPEND CPU_DEFS
		HAS_ARM7=1 HAS_M68000=1 HAS_Z180=1 HAS_Z80=1
	)
endif()
if(OPT_IREM)
	...
	list(APPEND CPU_DEFS
		HAS_8085A=1 HAS_I8039=1 HAS_M6502=1 HAS_M6800=1
		HAS_M6802=1 HAS_M6803=1 HAS_V30=1 HAS_V33=1
		HAS_Z80=1 	)
endif()
if(OPT_ITECH)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YM3812=1 	)
	list(APPEND CPU_DEFS
		HAS_M68000=1 HAS_M6809=1 HAS_M6809E=1 HAS_TMS32031=1
		HAS_Z80=1 	)
endif()
if(OPT_JALECO)
	...
	set(MCPU_Z80 ON)
	list(APPEND CPU_DEFS
		HAS_AY8910=1 HAS_OKIM6295=1 HAS_Y8950=1 HAS_YM2151=1
		HAS_YM2203=1 HAS_YM3812=1 HAS_YMF271=1 HAS_YMZ280B=1
	)
	list(APPEND CPU_DEFS
...
if(OPT_KANEKO)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YMZ280B=1 	)
	list(APPEND CPU_DEFS
		HAS_M68000=1 HAS_SH2=1 HAS_Z80=1 	)
endif()
if(OPT_KONAMI)
	...
	list(APPEND CPU_DEFS
		...
		HAS_PPC403=1 HAS_PPC602=1 HAS_PSXCPU=1 HAS_S2650=1
		HAS_Z80=1 	)
endif()
if(OPT_MEADOWS)
...
if(OPT_MIDW8080)
	...
	list(APPEND CPU_DEFS
		...
		HAS_SN76477=1 	)
	list(APPEND CPU_DEFS
		HAS_8080=1 HAS_8085A=1 HAS_I8039=1 HAS_Z80=1
	)
endif()
if(OPT_MIDWAY)
	...
	list(APPEND MAME_DRIVERS_SRC
		...
		vidhrdw/mcr68.c drivers/midtunit.c machine/midtunit.c vidhrdw/midtunit.c  vidhrdw/midtunit.cpp
	...
	set(MCPU_TMS32031 ON)
	set(MCPU_TMS34010 ON)
	set(MCPU_TMS34020 ON)
	set(MCPU_Z80 ON)
	list(APPEND CPU_DEFS
		HAS_ASTROCADE=1 HAS_AY8910=1 HAS_CEM3394=1 HAS_CUSTOM=1
		HAS_DAC=1 HAS_DMADAC=1 HAS_HC55516=1 HAS_OKIM6295=1
		HAS_SAMPLES=1 HAS_TMS5220=1 HAS_YM2151=1 	)
	list(APPEND CPU_DEFS
		HAS_ADSP2100=1 HAS_ADSP2105=1 HAS_ADSP2115=1 HAS_ADSP2181=1
		HAS_M6800=1 HAS_M68000=1 HAS_M6802=1 HAS_M6808=1
...
if(OPT_MIDWAYTUNIT)
	...
	list(APPEND MAME_DRIVERS_SRC
		drivers/midtunit.c machine/midtunit.c vidhrdw/midtunit.c vidhrdw/midtunit.cpp drivers/midyunit.c
...
if(OPT_MISC)
	...
	list(APPEND CPU_DEFS
		...
		HAS_I8052=1 HAS_I88=1 HAS_M6502=1 HAS_M65C02=1
		HAS_M65SC02=1 HAS_M68000=1 HAS_M6802=1 HAS_M6809=1
		HAS_M6809E=1 HAS_M68705=1 HAS_M68EC020=1 HAS_R3000BE=1
		HAS_S2650=1 HAS_SE3208=1 HAS_TMS32010=1 HAS_TMS32025=1
		HAS_TMS32026=1 HAS_TMS34010=1 HAS_TMS9980=1 HAS_UPD7807=1
		HAS_UPD7810=1 HAS_V30=1 HAS_Z180=1 HAS_Z80=1
	)
endif()
if(OPT_NAMCO)
	...
	list(APPEND CPU_DEFS
		...
		HAS_M65C02=1 HAS_M6800=1 HAS_M68000=1 HAS_M68020=1
...
if(OPT_NICHIBUT)
	...
	list(APPEND CPU_DEFS
		...
		HAS_OKIM6295=1 HAS_SAMPLES=1 HAS_YM2203=1 HAS_YM3526=1
		HAS_YM3812=1 	)
	list(APPEND CPU_DEFS
		HAS_M68000=1 HAS_NSC8105=1 HAS_Z80=1 	)
endif()
if(OPT_NINTENDO)
	...
	set(MCPU_Z80 ON)
	list(APPEND CPU_DEFS
		HAS_AY8910=1 HAS_CUSTOM=1 HAS_DAC=1 HAS_NES=1
		HAS_SAMPLES=1 HAS_SN76477=1 HAS_VLM5030=1 	)
	list(APPEND CPU_DEFS
		HAS_8080=1 HAS_G65816=1 HAS_I8035=1 HAS_I8039=1
		HAS_M6502=1 HAS_N2A03=1 HAS_S2650=1 HAS_SPC700=1
		HAS_Z80=1 	)
endif()
if(OPT_NIX)
...
if(OPT_PLAYMARK)
	...
	set(MCPU_I8051 ON)
	set(MCPU_M68000 ON)
	set(MCPU_PIC16C57 ON)
	list(APPEND CPU_DEFS
		HAS_OKIM6295=1 	)
	list(APPEND CPU_DEFS
		HAS_I8051=1 HAS_M68000=1 HAS_PIC16C57=1 	)
endif()
if(OPT_PSIKYO)
...
if(OPT_RARE)
	...
	list(APPEND CPU_DEFS
		HAS_ADSP2100=1 HAS_R4600LE=1 HAS_TMS34010=1 HAS_TMS34020=1
		HAS_Z80=1 	)
endif()
if(OPT_SANRITSU)
...
if(OPT_SEGA)
	...
	list(APPEND CPU_DEFS
		HAS_AY8910=1 HAS_CUSTOM=1 HAS_DAC=1 HAS_DISCRETE=1
		HAS_MSM5205=1 HAS_MULTIPCM=1 HAS_OKIM6295=1 HAS_RF5C68=1
		HAS_SAMPLES=1 HAS_SCSP=1 HAS_SEGAPCM=1 HAS_SN76496=1
		HAS_SP0250=1 HAS_TMS36XX=1 HAS_UPD7759=1 HAS_YM2151=1
		HAS_YM2203=1 HAS_YM2413=1 HAS_YM3438=1 HAS_YM3812=1
	)
	list(APPEND CPU_DEFS
		HAS_8080=1 HAS_I8035=1 HAS_I8039=1 HAS_I8751=1
		HAS_M68000=1 HAS_N7751=1 HAS_SH2=1 HAS_V20=1
		HAS_V60=1 HAS_V70=1 HAS_Z80=1 	)
endif()
if(OPT_SEIBU)
	...
	list(APPEND CPU_DEFS
		HAS_I386=1 HAS_M6800=1 HAS_M68000=1 HAS_V20=1
		HAS_V30=1 HAS_Z80=1 	)
endif()
if(OPT_SETA)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YM3438=1 HAS_YM3812=1 	)
	list(APPEND CPU_DEFS
		HAS_M65C02=1 HAS_M68000=1 HAS_M68EC020=1 HAS_R3000BE=1
		HAS_R4600BE=1 HAS_RSP=1 HAS_V60=1 HAS_V810=1
		HAS_Z80=1 	)
endif()
if(OPT_SHARED)
...
if(OPT_SUN)
	...
	list(APPEND CPU_DEFS
		...
		HAS_SN76496=1 HAS_YM2203=1 HAS_YM3438=1 	)
	list(APPEND CPU_DEFS
		HAS_M68000=1 HAS_V30=1 HAS_Z80=1 	)
endif()
if(OPT_SUNA)
...
if(OPT_TAD)
	...
	set(MCPU_Z80 ON)
	list(APPEND CPU_DEFS
		HAS_CUSTOM=1 HAS_MSM5205=1 HAS_OKIM6295=1 HAS_YM2151=1
		HAS_YM2203=1 HAS_YM3812=1 	)
	list(APPEND CPU_DEFS
		HAS_M68000=1 HAS_Z80=1 	)
endif()
if(OPT_TAITO)
	...
	set(MCPU_M68705 ON)
	set(MCPU_M68EC020 ON)
	set(MCPU_MC68HC11 ON)
	set(MCPU_PENTIUM ON)
	set(MCPU_TMS32025 ON)
	set(MCPU_TMS32051 ON)
	set(MCPU_Z80 ON)
	list(APPEND CPU_DEFS
		HAS_AY8910=1 HAS_CUSTOM=1 HAS_DAC=1 HAS_DISCRETE=1
	...
	list(APPEND CPU_DEFS
		...
		HAS_M68040=1 HAS_M6805=1 HAS_M6809=1 HAS_M68705=1
		HAS_M68EC020=1 HAS_MC68HC11=1 HAS_PENTIUM=1 HAS_TMS32025=1
		HAS_TMS32051=1 HAS_Z80=1 	)
endif()
if(OPT_TATSUMI)
	...
	list(APPEND CPU_DEFS
		HAS_I86=1 HAS_M68000=1 HAS_V20=1 HAS_V30=1
		HAS_Z80=1 	)
endif()
if(OPT_TCH)
	...
	list(APPEND CPU_DEFS
		HAS_OKIM6295=1 	)
	list(APPEND CPU_DEFS
		HAS_M68000=1 HAS_PIC16C57=1 HAS_Z80=1 	)
endif()
if(OPT_TECFRI)
...
if(OPT_TECHNOS)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YM3812=1 	)
	list(APPEND CPU_DEFS
		HAS_HD6309=1 HAS_HD63701=1 HAS_I8039=1 HAS_I8048=1
		HAS_M6502=1 HAS_M6800=1 HAS_M68000=1 HAS_M6809=1
		HAS_M68705=1 HAS_Z80=1 	)
endif()
if(OPT_TEHKAN)
...
if(OPT_TOAPLAN)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YM3812=1 HAS_YMZ280B=1 	)
	list(APPEND CPU_DEFS
		HAS_M68000=1 HAS_M68705=1 HAS_TMS32010=1 HAS_Z180=1
		HAS_Z80=1 	)
endif()
if(OPT_TONG)
...
if(OPT_UNICO)
	...
	set(MCPU_M68000 ON)
	set(MCPU_M68EC020 ON)
	set(MCPU_PIC16C55 ON)
	list(APPEND CPU_DEFS
		HAS_OKIM6295=1 HAS_YM2151=1 HAS_YM3812=1 	)
	list(APPEND CPU_DEFS
		HAS_M68000=1 HAS_M68EC020=1 HAS_PIC16C55=1 	)
endif()
if(OPT_UNIVERS)
...
if(OPT_VENTURE)
	...
	list(APPEND CPU_DEFS
		HAS_8085A=1 HAS_I8035=1 HAS_I8039=1 HAS_TMS9980=1
		HAS_TMS9995=1 HAS_Z80=1 	)
endif()
if(OPT_VSYSTEM)
