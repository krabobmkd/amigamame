...
if(OPT_ATARI)
	...
	list(APPEND CPU_DEFS
		...
		HAS_JAGUARDSP=1 HAS_JAGUARGPU=1 HAS_M6502=1 HAS_M6800=1 
		HAS_M68000=1 HAS_M68010=1 HAS_M6809=1 HAS_M68EC020=1 
		HAS_MEDIAGX=1 HAS_R3000BE=1 HAS_S2650=1 HAS_T11=1 
		HAS_TMS32010=1 HAS_TMS32031=1 HAS_TMS34010=1 	)
endif()
if(OPT_ATLUS)
...
if(OPT_CINEMAT)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YM2151=1 	)
	list(APPEND CPU_DEFS
		HAS_CCPU=1 HAS_I86=1 HAS_M68000=1 HAS_S2650=1 
		HAS_Z80=1 	)
endif()
if(OPT_COMAD)
...
if(OPT_GAMEPLAN)
	...
	list(APPEND CPU_DEFS
		HAS_AY8910=1 	)
	list(APPEND CPU_DEFS
		HAS_M6502=1 HAS_M6800=1 HAS_Z80=1 	)
endif()
if(OPT_GAMETRON)
...
if(OPT_IGS)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YM3812=1 	)
	list(APPEND CPU_DEFS
		HAS_ARM7=1 HAS_Z180=1 HAS_Z80=1 	)
endif()
if(OPT_IREM)
...
if(OPT_METRO)
	...
	list(APPEND CPU_DEFS
		...
		HAS_YMF278B=1 	)
	list(APPEND CPU_DEFS
		HAS_M68000=1 HAS_UPD7810=1 HAS_Z80=1 	)
endif()
if(OPT_MIDCOIN)
...
if(OPT_MIDW8080)
	...
	list(APPEND CPU_DEFS
		...
		HAS_SN76477=1 	)
	list(APPEND CPU_DEFS
		HAS_8080=1 HAS_I8039=1 HAS_Z80=1 	)
endif()
if(OPT_MIDWAY)
	...
	list(APPEND CPU_DEFS
		HAS_ADSP2100=1 HAS_M6800=1 HAS_M68000=1 HAS_M6809=1 
		HAS_TMS32031=1 HAS_TMS34010=1 HAS_TMS34020=1 HAS_Z80=1 
	)
endif()
if(OPT_MIDWAYTUNIT)
...
if(OPT_MISC)
	...
	list(APPEND CPU_DEFS
		...
		HAS_E132XT=1 HAS_H83002=1 HAS_I8051=1 HAS_I8052=1 
		HAS_I88=1 HAS_M6502=1 HAS_M65C02=1 HAS_M68000=1 
		HAS_M6802=1 HAS_M6809=1 HAS_M6809E=1 HAS_M68705=1 
		HAS_M68EC020=1 HAS_S2650=1 HAS_SE3208=1 HAS_TMS32010=1 
		HAS_TMS32025=1 HAS_TMS32026=1 HAS_TMS34010=1 HAS_TMS9980=1 
		HAS_UPD7807=1 HAS_UPD7810=1 HAS_V30=1 HAS_Z180=1 
		HAS_Z80=1 	)
endif()
if(OPT_NAMCO)
	...
	list(APPEND CPU_DEFS
		...
		HAS_M37702=1 HAS_M37710=1 HAS_M6502=1 HAS_M65C02=1 
		HAS_M6800=1 HAS_M68000=1 HAS_M68020=1 HAS_M6805=1 
		HAS_M6809=1 HAS_M68EC020=1 HAS_PSXCPU=1 HAS_R4650BE=1 
...
if(OPT_NINTENDO)
	...
	list(APPEND CPU_DEFS
		...
		HAS_M6502=1 HAS_N2A03=1 HAS_S2650=1 HAS_Z80=1 
	)
endif()
if(OPT_NIX)
...
if(OPT_SETA)
	...
	list(APPEND CPU_DEFS
		...
		HAS_R4600BE=1 HAS_RSP=1 HAS_V810=1 HAS_Z80=1 
	)
endif()
if(OPT_SHARED)
