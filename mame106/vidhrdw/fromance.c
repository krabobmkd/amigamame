				...
				for (yt = 0; yt < ytiles; yt++)
					for (xt = 0; xt < xtiles; xt++, code++)
						...
						else
						{
							...
							dgpz0.sx = x + xt * xzoom;
							dgpz0.sy = y + yt * yzoom;
							dgpz0.scalex = 0x1000 * xzoom;
							dgpz0.scaley = 0x1000 * yzoom;
							drawgfxzoom(&dgpz0);
                        }
			}
