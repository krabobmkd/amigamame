  ...
  };
{
				...
				dgp2.flipx = flipx;
				dgp2.flipy = flipy;
				dgp2.sx = flipx ? sx+16 : sx;
				dgp2.sy = flipy ? sy-16 : sy;
				drawgfx(&dgp2);
  ...
  };
{
				...
				dgp4.flipx = flipx;
				dgp4.flipy = flipy;
				dgp4.sx = flipx ? sx+16 : sx;
				dgp4.sy = flipy ? sy-16 : sy;
				drawgfx(&dgp4);
