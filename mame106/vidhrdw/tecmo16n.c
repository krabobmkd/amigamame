...
static void draw_sprites(mame_bitmap *bitmap_bg, mame_bitmap *bitmap_fg, mame_bitmap *bitmap_sp, const rectangle *cliprect)
{
	...
	{
		{ 0, 1, 4, 5,16,17,20,21}5,16,17,20,21},
		{ 2, 3, 6, 7,18,19,22,23}7,18,19,22,23},
		{ 8, 9,12,13,24,25,28,29}9,12,13,24,25,28,29},
		{10,11,14,15,26,27,30,31}{10,11,14,15,26,27,30,31},
		{32,33,36,37,48,49,52,53}{32,33,36,37,48,49,52,53},
		{34,35,38,39,50,51,54,55}{34,35,38,39,50,51,54,55},
