...
static inline UINT16 paletteram16_le(offs_t offset)
{
...
static inline UINT16 paletteram16_be(offs_t offset)
{
	return paletteram[offset | 1] | (paletteram[offset & ~1] << 8);
}
...
static inline UINT16 paletteram16_split(offs_t offset)
{
...
static inline UINT32 paletteram32_be(offs_t offset)
{
...
static inline void set_color_444(pen_t color, int rshift, int gshift, int bshift, UINT16 data)
{
...
static inline void set_color_4444(pen_t color, int ishift, int rshift, int gshift, int bshift, UINT16 data)
{
...
static inline void set_color_888(pen_t color, int rshift, int gshift, int bshift, UINT32 data)
{
