...
static void zodiack_draw_bullets( mame_bitmap *bitmap )
{
	...
	for (offs = 0; offs < zodiack_bulletsram_size; offs += 4)
	{
		...
		dgp0.color = /* this is just a dot;
		dgp0.flipx = generated by the hardware */			0;
		dgp0.sy = x;
		drawgfx(&dgp0);
	}
...
static void zodiack_draw_sprites( mame_bitmap *bitmap )
{
	...
	struct drawgfxParams dgp1={
		...
		0, 	// sx
		0, 	// sy
		//flip_screen[0] ? &spritevisibleareaflipx : &spritevisiblearea, 	// clip
		TRANSPARENCY_PEN, 	// transparency
		0);			//&spritevisiblearea, 	// transparent_color
		0, 	// scalex
		0, 	// scaley
		NULL, 	// pri_buffer
		0 	// priority_mask
