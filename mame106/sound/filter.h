...
{
	float x0, x1, x2;	/* x[k], x[k-1], x[k-2], current and previous 2 input values */
	float y0, y1, y2;	/* y[k], y[k-1], y[k-2], current and previous 2 output values */
	float a1, a2;		/* digital filter coefficients, denominator */
	float b0, b1, b2;	/* digital filter coefficients, numerator */
};
