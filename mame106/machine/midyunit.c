...
static const struct protection_data *prot_data=0L;
static UINT16 prot_result=0;
static UINT16 prot_sequence[3]={0,0,0};
static UINT8 prot_index=0;


/* input-related variables */
static UINT8	term2_analog_select=0;
