...
static UINT8	cmos_write_enable = 0;

/* sound-related variables */
static UINT8	sound_type = 0;
static UINT8	fake_sound_state = 0;
...
static const UINT32 *nbajam_prot_table=0L;
static UINT16 nbajam_prot_queue[5]={0};
static UINT8 nbajam_prot_index=0;
