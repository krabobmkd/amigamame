  ...
  };
{
	...
	dgp0.code = OBJ_CODE(marinedt_obj1_a);
	dgp0.color = OBJ_COLOR(marinedt_obj1_a);
	dgp0.flipx = OBJ_FLIPX(marinedt_obj1_a);
	dgp0.flipy = OBJ_FLIPY(marinedt_obj1_a);
	drawgfx(&dgp0);

	fillbitmap(obj2, Machine->pens[0], NULL);
	
	dgp1.code = OBJ_CODE(marinedt_obj2_a);
	dgp1.color = OBJ_COLOR(marinedt_obj2_a);
	dgp1.flipx = OBJ_FLIPX(marinedt_obj2_a);
	dgp1.flipy = OBJ_FLIPY(marinedt_obj2_a);
	drawgfx(&dgp1);
...
GAME( 1981, marinedt, 0, marinedt, marinedt, 0, ROT270, "Taito", "Marine Date", GAME_NO_SOUND ,0,2,egg_Maze,0)
