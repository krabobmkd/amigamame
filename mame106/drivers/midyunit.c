...
ROM_START( narc )
	...
	ROM_REGION( 0x90000, REGION_CPU3, 0 )	/* slave sound CPU */
	...
	ROM_LOAD( "u37-snd", 0x50000, 0x10000, CRC(29dbeffd) SHA1(4cbdc619db34f9c552de1ed3d034f8c079987e03) )
	ROM_RELOAD(          0x60000, 0x10000 )
	ROM_LOAD( "u38-snd", 0x70000, 0x10000, CRC(09b03b80) SHA1(a45782d29a426fac38299b56af0815e844e35ae4) )
	ROM_RELOAD(          0x80000, 0x10000 )
...
ROM_START( mkprot9 )
	...
	ROM_REGION( 0x200000, REGION_SOUND1, 0 )	/* ADPCM */
...
GAME( 1988, narc,     0,       zunit,    narc,    narc,     ROT0, "Williams", "Narc (rev 7.00)", 0 ,2,0,egg_Platform,EGF_UViolent)
GAME( 1988, narc3,    narc,    zunit,    narc,    narc,     ROT0, "Williams", "Narc (rev 3.20)", 0 ,2,0,egg_Platform,EGF_UViolent)

GAME( 1990, trog,     0,       trog,     trog,    trog,     ROT0, "Midway",   "Trog (rev LA4 03/11/91)", 0 ,0,0,egg_Unknown,0)
GAME( 1990, trog3,    trog,    trog,     trog,    trog,     ROT0, "Midway",   "Trog (rev LA3 02/14/91)", 0 ,4,0,egg_Maze,0)
GAME( 1990, trogpa6,  trog,    trog,     trog,    trog,     ROT0, "Midway",   "Trog (rev PA6-PAC 09/09/90)", 0 ,4,0,egg_Maze,0)
GAME( 1990, trogp,    trog,    trog,     trog,    trog,     ROT0, "Midway",   "Trog (prototype, rev 4.00 07/27/90)", 0 ,0,0,egg_Unknown,0)
GAME( 1991, strkforc, 0,       strkforc, strkforc,strkforc, ROT0, "Midway",   "Strike Force (rev 1 02/25/91)", 0 ,2,0,egg_ShootEmUp,0)

GAME( 1990, smashtv,  0,       smashtv,  smashtv, smashtv,  ROT0, "Williams", "Smash T.V. (rev 8.00)", 0 ,2,0,egg_ShootEmUp,EGF_UViolent|EGF_Hentai)
GAME( 1990, smashtv6, smashtv, smashtv,  smashtv, smashtv,  ROT0, "Williams", "Smash T.V. (rev 6.00)", 0 ,2,0,egg_ShootEmUp,EGF_UViolent|EGF_Hentai)
GAME( 1990, smashtv5, smashtv, smashtv,  smashtv, smashtv,  ROT0, "Williams", "Smash T.V. (rev 5.00)", 0 ,2,0,egg_ShootEmUp,EGF_UViolent|EGF_Hentai)
GAME( 1990, smashtv4, smashtv, smashtv,  smashtv, smashtv,  ROT0, "Williams", "Smash T.V. (rev 4.00)", 0 ,2,0,egg_ShootEmUp,EGF_UViolent|EGF_Hentai)
GAME( 1990, hiimpact, 0,       hiimpact, trog,    hiimpact, ROT0, "Williams", "High Impact Football (rev LA4 02/04/91)", 0 ,0,0,egg_Unknown,0)
GAME( 1990, hiimpac3, hiimpact,hiimpact, trog,    hiimpact, ROT0, "Williams", "High Impact Football (rev LA3 12/27/90)", 0 ,0,0,egg_Unknown,0)
GAME( 1990, hiimpacp, hiimpact,hiimpact, trog,    hiimpact, ROT0, "Williams", "High Impact Football (prototype, rev 8.6 12/09/90)", 0 ,0,0,egg_Unknown,0)
GAME( 1991, shimpact, 0,       hiimpact, trog,    shimpact, ROT0, "Midway",   "Super High Impact (rev LA1 09/30/91)", GAME_NOT_WORKING ,4,0,egg_sport_Football,0)
GAME( 1991, shimpacp, shimpact,hiimpact, trog,    shimpact, ROT0, "Midway",   "Super High Impact (prototype, rev 5.0 09/15/91)", GAME_NOT_WORKING ,4,0,egg_sport_Football,0)

GAME( 1991, term2,    0,       term2,    term2,   term2,    ORIENTATION_FLIP_X, "Midway",   "Terminator 2 - Judgment Day (rev LA3 03/27/92)", 0 ,0,0,egg_Unknown,0)
GAME( 1991, term2la2, term2,   term2,    term2,   term2la2, ORIENTATION_FLIP_X, "Midway",   "Terminator 2 - Judgment Day (rev LA2 12/09/91)", 0 ,2,0,egg_LightGuns,0)
GAME( 1991, term2la1, term2,   term2,    term2,   term2la1, ORIENTATION_FLIP_X, "Midway",   "Terminator 2 - Judgment Day (rev LA1 11/01/91)", 0 ,2,0,egg_LightGuns,0)
GAME( 1992, mkprot9,  mk,      mk,       mkla2,   mkyunit,  ROT0, "Midway",   "Mortal Kombat (prototype, rev 9.0 07/28/92)", 0 ,2,0,egg_Fighter,EGF_UViolent)
GAME( 1992, mkla1,    mk,      mk,       mkla2,   mkyunit,  ROT0, "Midway",   "Mortal Kombat (rev 1.0 08/09/92)", 0 ,2,0,egg_Fighter,EGF_UViolent)
GAME( 1992, mkla2,    mk,      mk,       mkla2,   mkyunit,  ROT0, "Midway",   "Mortal Kombat (rev 2.0 08/18/92)", 0 ,2,0,egg_Fighter,EGF_UViolent)
GAME( 1992, mkla3,    mk,      mk,       mkla4,   mkyunit,  ROT0, "Midway",   "Mortal Kombat (rev 3.0 08/31/92)", 0 ,2,0,egg_Fighter,EGF_UViolent)
GAME( 1992, mkla4,    mk,      mk,       mkla4,   mkyunit,  ROT0, "Midway",   "Mortal Kombat (rev 4.0 09/28/92)", 0 ,2,0,egg_Fighter,EGF_UViolent)
GAME( 1992, mkyawdim, mk,      mkyawdim, mkla4,   mkyawdim, ROT0, "Midway",   "Mortal Kombat (Yawdim bootleg)", 0 ,2,0,egg_Fighter,EGF_UViolent)
GAME( 1992, totcarn,  0,       totcarn,  totcarn, totcarn,  ROT0, "Midway",   "Total Carnage (rev LA1 03/10/92)", 0 ,2,0,egg_ShootEmUp,EGF_UViolent)
GAME( 1992, totcarnp, totcarn, totcarn,  totcarn, totcarn,  ROT0, "Midway",   "Total Carnage (prototype, rev 1.0 01/25/92)", 0 ,2,0,egg_ShootEmUp,EGF_UViolent)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              