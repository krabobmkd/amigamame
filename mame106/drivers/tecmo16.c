...
GAME( 1992, fstarfrc, 0, fstarfrc, fstarfrc, 0, ROT90, "Tecmo", "Final Star Force (US)", 0 ,2,0,egg_ShootEmUp,EGF_VER)
GAME( 1992, riot,     0, riot,     riot,     0, ROT0,  "NMK",   "Riot", 0 ,2,0,egg_Shooter,0)
GAME( 1995, ginkun,   0, ginkun,   ginkun,   0, ROT0,  "Tecmo", "Ganbare Ginkun", 0 ,2,0,egg_Compilation,0)
