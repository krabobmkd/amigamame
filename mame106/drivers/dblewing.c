...
static void dblewing_drawsprites(mame_bitmap *bitmap,const rectangle *cliprect)
{
	...
	for (offs = 0x400-4;offs >= 0;offs -= 4)
	{
		...
		while (multi >= 0)
		{
			...
			dgp0.code = (sprite - multi * inc)-mult2;
			dgp0.color = colour;
			dgp0.flipx = fx;
			dgp0.flipy = fy;
			dgp0.sx = x-16;
...
GAME( 1993, dblewing, 0,        dblewing, dblewing,  dblewing,  ROT90,"Mitchell", "Double Wings", GAME_UNEMULATED_PROTECTION | GAME_NO_SOUND|GAME_NOT_WORKING,2,0,egg_ShootEmUp,0)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        