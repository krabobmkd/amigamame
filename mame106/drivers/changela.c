...
/* draw the scanline */
	...
	for (sy = 0; sy < 256; sy+=8)
	{
		for (sx = 0; sx < 256; sx+=8)
		{
			...
			dgp0.code = tile;
			dgp0.color = 8 + ((attr>>6)&0x03);
			dgp0.flipx = /* color; OBJ1s use palette entries 0x20-0x2f (color code=8) */				0;
			dgp0.sx = /* flip */				sx+(attr&0x0f);
			dgp0.sy = sy;
			drawgfx(&dgp0); /* fix it: should be 7 */
#endif
		}
	}
...
GAME( 1983, changela, 0, changela, changela, changela, ROT180, "Taito Corporation", "Change Lanes", GAME_NOT_WORKING | GAME_IMPERFECT_GRAPHICS ,0,2,egg_Driving,0)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            