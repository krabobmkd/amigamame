...
static READ16_HANDLER( topspeed_motor_r )
{
	switch (offset)
	{
		...
		default:
loginfo(2,"CPU #0 PC %06x: warning - read from motor cpu %03x\n",activecpu_get_pc(),offset);
			return 0;
	}
}
...
GAME( 1987, topspeed, 0,        topspeed, topspeed, topspeed, ROT0, "Taito Corporation Japan", "Top Speed (World)", 0 ,1)
GAME( 1987, topspedu, topspeed, topspeed, topspedu, topspeed, ROT0, "Taito America Corporation (Romstar license)", "Top Speed (US)", 0 ,1)
GAME( 1987, fullthrl, topspeed, topspeed, fullthrl, topspeed, ROT0, "Taito Corporation", "Full Throttle (Japan)", 0 ,1)
