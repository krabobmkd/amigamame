...
ROM_START( ssfindo )
	...
	ROM_REGION(0x80, REGION_USER3, 0 ) /* eeprom */
...
GAME( 1999, ssfindo, 0,        ssfindo,  ssfindo,  ssfindo, ROT0, "Icarus", "See See Find Out", GAME_NO_SOUND ,2,0,egg_Puzzle,0)
GAME( 1999, ppcar,   0,        ppcar,    ppcar,    ppcar, ROT0, "Icarus", "Pang Pang Car", GAME_NO_SOUND ,0,1,egg_Mature,0)
