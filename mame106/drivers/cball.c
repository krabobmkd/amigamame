  ...
  };
{
	...
	dgp0.code = cball_video_ram[0x399] >> 4;
	dgp0.sx = 240 - cball_video_ram[0x390];
	dgp0.sy = 240 - cball_video_ram[0x398];
	drawgfx(&dgp0);
}
...
GAME( 1976, cball, 0, cball, cball, 0, ROT0, "Atari", "Cannonball (Atari, prototype)", GAME_NO_SOUND | GAME_WRONG_COLORS | GAME_IMPERFECT_GRAPHICS ,0,2,egg_BallNPaddles,0)
