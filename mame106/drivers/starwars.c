...
static MACHINE_DRIVER_START( starwars )
	...
	MDRV_SCREEN_SIZE(640, 480) //krb sez: must, for the moment. sadly overriden by option.
...
GAME( 1983, starwars, 0,        starwars, starwars, starwars, ROT0, "Atari", "Star Wars (rev 2)", 0 ,0,1,egg_Flying,EGF_P3D)
GAME( 1983, starwar1, starwars, starwars, starwars, starwars, ROT0, "Atari", "Star Wars (rev 1)", 0 ,0,1,egg_Flying,EGF_P3D)
GAME( 1985, esb,      0,        starwars, esb,      esb,      ROT0, "Atari Games", "Star Wars The Empire Strikes Back", 0 ,0,1,egg_Flying,EGF_P3D)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              
