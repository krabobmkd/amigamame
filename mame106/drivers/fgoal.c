...
GAME( 1979, fgoal,  0,     fgoal, fgoal, 0, ROT90, "Taito", "Field Goal",             GAME_NO_SOUND ,0,2,egg_BallNPaddles,0)
GAME( 1979, fgoala, fgoal, fgoal, fgoal, 0, ROT90, "Taito", "Field Goal (different)", GAME_NO_SOUND ,0,2,egg_BallNPaddles,0)
