  ...
  };
{
	...
	dgp0.code = 0x320;
	dgp0.sx = vroulet_ball[1];
	dgp0.sy = vroulet_ball[0] - 12;
	drawgfx(&dgp0);
}
...
GAME( 1989, vroulet, 0, vroulet, vroulet, 0, ROT90, "World Game", "Vegas Roulette", GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_COLORS ,0,1,egg_Casino,0)
                                                                                                                                                                                                                                                                                                                           