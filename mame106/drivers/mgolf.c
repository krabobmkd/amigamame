...
static VIDEO_UPDATE( mgolf )
{
	...
	for (i = 0; i < 2; i++)
	{
		...
		dgp0.code = mgolf_video_ram[0x399 + 4 * i];
		dgp0.color = i;
		dgp0.sx = mgolf_video_ram[0x390 + 2 * i] - 7;
		dgp0.sy = mgolf_video_ram[0x398 + 4 * i] - 16;
		drawgfx(&dgp0);

		
		dgp0.code = mgolf_video_ram[0x39b + 4 * i];
		dgp0.color = i;
		dgp0.sx = mgolf_video_ram[0x390 + 2 * i] - 15;
		dgp0.sy = mgolf_video_ram[0x39a + 4 * i] - 16;
		drawgfx(&dgp0);
	}
...
GAME( 1978, mgolf, 0, mgolf, mgolf, 0, ROT270, "Atari", "Atari Mini Golf (prototype)", GAME_NO_SOUND ,0,1,egg_sport_Golf,0)
                                                                                                                                                                                                                                                                                                                                                   