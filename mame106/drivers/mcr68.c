...
ROM_START( archrivl )
	...
	ROM_REGION( 0x90000, REGION_CPU2, 0 )  /* Audio System board */
...
GAME( 1990, pigskin,  0,        pigskin,  pigskin,  pigskin,  ROT0,   "Midway", "Pigskin 621AD", GAME_SUPPORTS_SAVE ,2,0,egg_sport_Rugby,0)
