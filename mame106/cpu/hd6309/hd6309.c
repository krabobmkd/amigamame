...
{
    // krb test
    // apparently this CPU takes way much time to compute for a 8bit.
    const int divider = 0;

 	hd6309_ICount = (cycles - hd6309.extra_cycles)>>divider;
...
//	hd6309_ICount = cycles - hd6309.extra_cycles;
	...
	return cycles - (hd6309_ICount<<divider);	 /* NS 970908 */
}
