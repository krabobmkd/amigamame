...
#define m68ki_read_program_8(A) 	m68k_read_memory_8(A)
#define m68ki_read_program_16(A) 	m68k_read_memory_16(A)
#define m68ki_read_program_32(A) 	m68k_read_memory_32(A)

/* Read from the data space */
#define m68ki_read_data_8(A) 	m68k_read_memory_8(A)
#define m68ki_read_data_16(A) 	m68k_read_memory_16(A)
#define m68ki_read_data_32(A) 	m68k_read_memory_32(A)
...
INLINE uint OPER_AY_AI_16(M68KOPT_PARAMS);
INLINE uint OPER_AY_AI_32(M68KOPT_PARAMS);
INLINE uint OPER_AY_PI_8(M68KOPT_PARAMS);
INLINE uint OPER_AY_PI_16(M68KOPT_PARAMS);
INLINE uint OPER_AY_PI_32(M68KOPT_PARAMS);
INLINE uint OPER_AY_PD_8(M68KOPT_PARAMS);
INLINE uint OPER_AY_PD_16(M68KOPT_PARAMS);
INLINE uint OPER_AY_PD_32(M68KOPT_PARAMS);
INLINE uint OPER_AY_DI_8(M68KOPT_PARAMS);
INLINE uint OPER_AY_DI_16(M68KOPT_PARAMS);
INLINE uint OPER_AY_DI_32(M68KOPT_PARAMS);
INLINE uint OPER_AY_IX_8(M68KOPT_PARAMS);
INLINE uint OPER_AY_IX_16(M68KOPT_PARAMS);
INLINE uint OPER_AY_IX_32(M68KOPT_PARAMS);

INLINE uint OPER_AX_AI_8(M68KOPT_PARAMS);
INLINE uint OPER_AX_AI_16(M68KOPT_PARAMS);
INLINE uint OPER_AX_AI_32(M68KOPT_PARAMS);
INLINE uint OPER_AX_PI_8(M68KOPT_PARAMS);
INLINE uint OPER_AX_PI_16(M68KOPT_PARAMS);
INLINE uint OPER_AX_PI_32(M68KOPT_PARAMS);
INLINE uint OPER_AX_PD_8(M68KOPT_PARAMS);
INLINE uint OPER_AX_PD_16(M68KOPT_PARAMS);
INLINE uint OPER_AX_PD_32(M68KOPT_PARAMS);
INLINE uint OPER_AX_DI_8(M68KOPT_PARAMS);
INLINE uint OPER_AX_DI_16(M68KOPT_PARAMS);
INLINE uint OPER_AX_DI_32(M68KOPT_PARAMS);
INLINE uint OPER_AX_IX_8(M68KOPT_PARAMS);
INLINE uint OPER_AX_IX_16(M68KOPT_PARAMS);
INLINE uint OPER_AX_IX_32(M68KOPT_PARAMS);

INLINE uint OPER_A7_PI_8(M68KOPT_PARAMS);
INLINE uint OPER_A7_PD_8(M68KOPT_PARAMS);

INLINE uint OPER_AW_8(M68KOPT_PARAMS);
INLINE uint OPER_AW_16(M68KOPT_PARAMS);
INLINE uint OPER_AW_32(M68KOPT_PARAMS);
INLINE uint OPER_AL_8(M68KOPT_PARAMS);
INLINE uint OPER_AL_16(M68KOPT_PARAMS);
INLINE uint OPER_AL_32(M68KOPT_PARAMS);
INLINE uint OPER_PCDI_8(M68KOPT_PARAMS);
INLINE uint OPER_PCDI_16(M68KOPT_PARAMS);
INLINE uint OPER_PCDI_32(M68KOPT_PARAMS);
INLINE uint OPER_PCIX_8(M68KOPT_PARAMS);
INLINE uint OPER_PCIX_16(M68KOPT_PARAMS);
...
INLINE uint m68ki_get_ea_ix( struct m68k_cpu_instance *p68k COREREG, uint An)
{
	...
	{
        uint afinal = m68ki_read_32(An + bd);
		return (afinal + Xn + od);
    }
...
/* Fetch operands */
INLINE uint OPER_AY_AI_8(M68KOPT_PARAMS)  {uint ea = EA_AY_AI_8();  return m68ki_read_8(ea); }
...
INLINE uint OPER_AY_DI_8(M68KOPT_PARAMS)  {uint ea = EA_AY_DI_8();  return m68ki_read_8(ea); }
INLINE uint OPER_AY_DI_16(M68KOPT_PARAMS) {uint ea = EA_AY_DI_16(); return m68ki_read_16(ea);}
INLINE uint OPER_AY_DI_32(M68KOPT_PARAMS) {uint ea = EA_AY_DI_32(); return m68ki_read_32(ea);}
INLINE uint OPER_AY_IX_8(M68KOPT_PARAMS)  {uint ea = EA_AY_IX_8();  return m68ki_read_8(ea); }
INLINE uint OPER_AY_IX_16(M68KOPT_PARAMS) {uint ea = EA_AY_IX_16(); return m68ki_read_16(ea);}
INLINE uint OPER_AY_IX_32(M68KOPT_PARAMS) {uint ea = EA_AY_IX_32(); return m68ki_read_32(ea);}

INLINE uint OPER_AX_AI_8(M68KOPT_PARAMS)  {uint ea = EA_AX_AI_8();  return m68ki_read_8(ea); }
INLINE uint OPER_AX_AI_16(M68KOPT_PARAMS) {uint ea = EA_AX_AI_16(); return m68ki_read_16(ea);}
INLINE uint OPER_AX_AI_32(M68KOPT_PARAMS) {uint ea = EA_AX_AI_32(); return m68ki_read_32(ea);}
INLINE uint OPER_AX_PI_8(M68KOPT_PARAMS)  {uint ea = EA_AX_PI_8();  return m68ki_read_8(ea); }
INLINE uint OPER_AX_PI_16(M68KOPT_PARAMS) {uint ea = EA_AX_PI_16(); return m68ki_read_16(ea);}
INLINE uint OPER_AX_PI_32(M68KOPT_PARAMS) {uint ea = EA_AX_PI_32(); return m68ki_read_32(ea);}
INLINE uint OPER_AX_PD_8(M68KOPT_PARAMS)  {uint ea = EA_AX_PD_8();  return m68ki_read_8(ea); }
INLINE uint OPER_AX_PD_16(M68KOPT_PARAMS) {uint ea = EA_AX_PD_16(); return m68ki_read_16(ea);}
INLINE uint OPER_AX_PD_32(M68KOPT_PARAMS) {uint ea = EA_AX_PD_32(); return m68ki_read_32(ea);}
INLINE uint OPER_AX_DI_8(M68KOPT_PARAMS)  {uint ea = EA_AX_DI_8();  return m68ki_read_8(ea); }
INLINE uint OPER_AX_DI_16(M68KOPT_PARAMS) {uint ea = EA_AX_DI_16(); return m68ki_read_16(ea);}
INLINE uint OPER_AX_DI_32(M68KOPT_PARAMS) {uint ea = EA_AX_DI_32(); return m68ki_read_32(ea);}
INLINE uint OPER_AX_IX_8(M68KOPT_PARAMS)  {uint ea = EA_AX_IX_8();  return m68ki_read_8(ea); }
INLINE uint OPER_AX_IX_16(M68KOPT_PARAMS) {uint ea = EA_AX_IX_16(); return m68ki_read_16(ea);}
INLINE uint OPER_AX_IX_32(M68KOPT_PARAMS) {uint ea = EA_AX_IX_32(); return m68ki_read_32(ea);}

INLINE uint OPER_A7_PI_8(M68KOPT_PARAMS)  {uint ea = EA_A7_PI_8();  return m68ki_read_8(ea); }
INLINE uint OPER_A7_PD_8(M68KOPT_PARAMS)  {uint ea = EA_A7_PD_8();  return m68ki_read_8(ea); }

INLINE uint OPER_AW_8(M68KOPT_PARAMS)     {uint ea = EA_AW_8();     return m68ki_read_8(ea); }
INLINE uint OPER_AW_16(M68KOPT_PARAMS)    {uint ea = EA_AW_16();    return m68ki_read_16(ea);}
INLINE uint OPER_AW_32(M68KOPT_PARAMS)    {uint ea = EA_AW_32();    return m68ki_read_32(ea);}
INLINE uint OPER_AL_8(M68KOPT_PARAMS)     {uint ea = EA_AL_8();     return m68ki_read_8(ea); }
INLINE uint OPER_AL_16(M68KOPT_PARAMS)    {uint ea = EA_AL_16();    return m68ki_read_16(ea);}
INLINE uint OPER_AL_32(M68KOPT_PARAMS)    {uint ea = EA_AL_32();    return m68ki_read_32(ea);}
INLINE uint OPER_PCDI_8(M68KOPT_PARAMS)   {uint ea = EA_PCDI_8();   return m68ki_read_pcrel_8(ea); }
INLINE uint OPER_PCDI_16(M68KOPT_PARAMS)  {uint ea = EA_PCDI_16();  return m68ki_read_pcrel_16(ea);}
INLINE uint OPER_PCDI_32(M68KOPT_PARAMS)  {uint ea = EA_PCDI_32();  return m68ki_read_pcrel_32(ea);}
INLINE uint OPER_PCIX_8(M68KOPT_PARAMS)   {uint ea = EA_PCIX_8();   return m68ki_read_pcrel_8(ea); }
INLINE uint OPER_PCIX_16(M68KOPT_PARAMS)  {uint ea = EA_PCIX_16();  return m68ki_read_pcrel_16(ea);}
INLINE uint OPER_PCIX_32(M68KOPT_PARAMS)  {uint ea = EA_PCIX_32();  return m68ki_read_pcrel_32(ea);}
...
INLINE void m68ki_jump(struct m68k_cpu_instance *p68k COREREG,uint new_pc)
{
	...
	REG_PC &= opcode_mask; //krb: this is mandatory for thunderforceac, better here than readimm_16/32()
}
...
INLINE void m68ki_exception_illegal(struct m68k_cpu_instance *p68k COREREG)
{
	...
	m68ki_stack_frame_0000(p68k,REG_PPC, sr, EXCEPTION_ILLEGAL_INSTRUCTION);
