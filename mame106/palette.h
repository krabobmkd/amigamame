...
#define PALETTE_DEFAULT_SHADOW_FACTOR (0.6f)
#define PALETTE_DEFAULT_HIGHLIGHT_FACTOR (1.0f/PALETTE_DEFAULT_SHADOW_FACTOR)

#define PALETTE_DEFAULT_SHADOW_FACTOR32 (0.6f)
#define PALETTE_DEFAULT_HIGHLIGHT_FACTOR32 (1.0f/PALETTE_DEFAULT_SHADOW_FACTOR32)
